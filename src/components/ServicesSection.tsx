...
const allServices = [
  ...
  },
  {
    ...
    badge: null,
    description: "Upskill your engineering team on GenAI best practices — from model integration and evaluation frameworks to safety guardrails and production-grade AI patterns.",
  },
];
