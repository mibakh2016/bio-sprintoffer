        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
              <p>
                Milla has 25+ years as a software architect and lead system designer, delivering architecture for autonomous tech and large-scale enterprise platforms. As former CTO of Predix, Lendindex, CA and other companies, she built reliable, high-performance architectures.
              </p>
              <p>
